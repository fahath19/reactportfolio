  ...
  return (
    <div className='flex    bg-gray-200 h-[90vh] lg:justify-around lg:items-center flex-col lg:flex-row mt-6  '>
      <div className='pl-6 lg:pl-0'>
       ...
       <p className='text-2xl lg:text-4xl mt-3 font-medium -z-30 '>I Am Into <span className='text-red-500 text-[1.5rem] lg:text-4xl '>{typing}</span> <span className=' -z-30'
       ...
       <div className="share-icon ">
           <ul className='flex text-4xl mt-4 cursor-pointer'>
            ...
            <li className='p-3 bg-black text-white rounded-[50%] text-[1.5rem] mr-2 hover:bg-violet-800 '> <a href="https://github.com/fahath19" target="_blank" > <FaGithub/></a>  </li>
            <li className='p-3 bg-black text-white rounded-[50%] text-[1.5rem] mr-2 hover:bg-pink-600'>  <a href="https://www.instagram.com/" target='_blank'> <FaInstagram/> </a> </li>
           </ul>
       </div>
      </div>
